...
def test_add_the_same_book_not_add_in_list(Books_Collector):
...
def test_set_book_rating_less_than_one_cant_set(Books_Collector):
    Books_Collector.add_new_book(name_book)
...
def test_set_book_rating_more_than_ten_cant_set(Books_Collector):
    Books_Collector.add_new_book(name_book)
